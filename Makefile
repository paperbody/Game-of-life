...
_DEPS = GameOfLife.h Cell.h

# Specify object files needed to build executable
_OBJ = app.o  GameOfLife.o Cell.o

# Specify object files needed to build test suite
TESTOBJ = $(TDIR)/$(ODIR)/test.o $(ODIR)/GameOfLife.o $(ODIR)/Cell.o

SCRATCHOBJ = $(PDIR)/$(ODIR)/scratchpad.o $(ODIR)/GameOfLife.o $(ODIR)/Cell.o
